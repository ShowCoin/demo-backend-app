...
@RequestMapping
// Required as otherwise Spring won't combine the configuration if the class or method is not already
...
public @interface VersionedResource {
     ...
     * @return
     */
    String[] media() default {"application/vnd.weipai.ios", "application/vnd.weipai.android"};
